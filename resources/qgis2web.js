...
map.getView().fit([39.507513, -4.153201, 39.959914, -3.907867], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mombasa Land Cover Classification</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (204 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'An interactive machine learning prediction map. A Random Forest classifier was trained on Sentinel-2 satellite imagery to predict Water, Built-up areas,Vegetation and Bareground classes with 89% accuracy.';
            }
